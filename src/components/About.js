...
const About = () => (
  <section data-testid="infoPokedex">
    <h2>{ `About ` + `Pokédex` }</h2>
    <section>
      <p data-testid="paragraphOne">
        This application simulates a Pokédex, a
        digital encyclopedia containing all Pokémons
      </p>
      <p data-testid="paragraphTwo">One can filter Pokémons by type, and see more details for each one of them</p>
      <img
