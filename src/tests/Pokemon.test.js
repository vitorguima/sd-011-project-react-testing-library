...
test('tests if the correct name, type and weight from pokémons shows at screen', () => {
...
test('tets the navigation link Deatils renders at URL /pokemons/<id>', () => {
...
test('test if the pokemon img render at screen', () => {
  renderWithRouter(<Pokemon pokemon={ favorite } isFavorite={ false } />);
...
test('test if favorited pokemon and the star shows at screen', () => {
