...
test('Teste se é exibido o próximo Pokémon se o botão Próximo pokémon é clicado.', () => {
...
test('Teste se é criado um botão de filtro dinamicamente', () => {
...
test('O botão de Próximo pokémon deve ser inativo quando tiver um só pokémon.', () => {
